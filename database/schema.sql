...
CREATE TABLE IF NOT EXISTS rides (
  ...
  co_rider_pickup_distance_meters INT DEFAULT 0,
  estimated_fare DECIMAL(10,2) NOT NULL,
  fare_share DECIMAL(10,2) DEFAULT NULL,
  eta_minutes INT,
  otp VARCHAR(10) NOT NULL,
  status ENUM('SEARCHING', 'POOLED', 'MATCHED', 'ACCEPTED', 'STARTED', 'COMPLETED', 'CANCELLED') DEFAULT 'SEARCHING',
